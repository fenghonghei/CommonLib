...
public class ImageUtil {
  ...
  public static Bitmap getBitmap(@DrawableRes int resId) {
    Drawable drawable = ContextCompat.getDrawable(AppUtil.getApp(), resId);
   ...
   * @return the bitmap with the specified color
   */
  public static Bitmap drawColor(@NonNull Bitmap src,
      @ColorInt int color,
      boolean recycle) {
   ...
   * @return the skewed bitmap
   */
  public static Bitmap skew(Bitmap src,
      float kx,
      float ky,
      boolean recycle) {
   ...
   * @return the round corner bitmap
   */
  public static Bitmap toRoundCorner(Bitmap src,
      float radius,
      boolean recycle) {
   ...
   * @return the round corner bitmap with border
   */
  public static Bitmap addCornerBorder(Bitmap src,
   ...
   * @return the round bitmap with border
   */
  public static Bitmap addCircleBorder(Bitmap src,
      @IntRange(from = 1) int borderSize,
      @ColorInt int color) {
   ...
   * @return the bitmap with border
   */
  private static Bitmap addBorder(Bitmap src,
      @IntRange(from = 1) int borderSize,
      @ColorInt int color,
      boolean isCircle,
      float cornerRadius,
   ...
   * @return the bitmap with reflection
   */
  public static Bitmap addReflection(Bitmap src,
      int reflectionHeight,
      boolean recycle) {
    if (isEmptyBitmap(src)) {
      return null;
    }
    int REFLECTION_GAP = 0;
   ...
   * @return the bitmap with text watermarking
   */
  public static Bitmap addTextWatermark(Bitmap src,
      String content,
      int textSize,
      @ColorInt int color,
      float x,
   ...
   * @return the bitmap with image watermarking
   */
  public static Bitmap addImageWatermark(Bitmap src,
      Bitmap watermark,
      int x, int y,
      int alpha) {
  ...
  public static Bitmap renderScriptBlur(Bitmap src,
    ...
    Bitmap ret = recycle ? src : src.copy(src.getConfig(), true);
    try {
      rs = RenderScript.create(AppUtil.getApp());
   ...
   */
  public static boolean save(Bitmap src,
      String filePath,
   ...
   * @return the compressed bitmap
   */
  public static Bitmap compressBySampleSize(Bitmap src,
      int sampleSize,
      boolean recycle) {
    if (isEmptyBitmap(src)) {
      return null;
